...
def result(request):
            ...
            # Traning model
            from joblib import dump , load
            model=load('C:/Users/shyam/OneDrive/Desktop/100%heart_disease_detection_web_updated/100%heart_disease_detection_web_updated/100%heart_disease_detection_web_updated/heart_disease_detection_web/Hello/projectApp/model/HEART_DISEASE_MODEL.joblib')
...
def result_new(request):
            ...
            # Traning model
            from joblib import dump , load
            model=load('C:/Users/shyam/OneDrive/Desktop/100%heart_disease_detection_web_updated/100%heart_disease_detection_web_updated/100%heart_disease_detection_web_updated/heart_disease_detection_web/Hello/projectApp/model/DT.joblib')  
            # Receive data from client
            lis = []       
            # Receive data from client
            lis.append(request.GET['Age'])
